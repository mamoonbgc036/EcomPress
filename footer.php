            ...
            <div class="row">
              <div class="col-md-4">
                <div class="newsletter-title">
                  <div class="newsletter-icon"><img src="<?php echo get_template_directory_uri(). '/images/newsletter-icon.png';?>" alt=" "></div>
        ...
        <div class="row"> 
          ...
          <div class="col-md-6 col-sm-6">
            <div class="payment float-none-xs center-sm">
              <img src="<?php echo get_template_directory_uri(). '/images/payment-method.png'; ?> " alt="">
            </div>
          </div>
        </div>
      </div>
